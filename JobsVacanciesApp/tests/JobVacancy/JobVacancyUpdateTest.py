...
class JobVacancyCreateTest(SeleniumStaticServernMixin):
    ...
    def test_create_vacancy(self):
        ...
        name_field = self.selenium.find_element_by_id('id_name')
        salary_range_field = Select(
            self.selenium.find_element_by_id('id_salary_range'))
        minimun_education_field = Select(
            self.selenium.find_element_by_id('id_minimum_education'))
        ...
        remove_btn = self.selenium.find_element_by_id(
            f"id_job_vacancy_{job_vacancy.pk}_remove_btn")
        remove_btn.click()
