 ...
 ;(function($) {
  $.fn.formset = function(opts)
  {
      var options = $.extend({}, $.fn.formset.defaults, opts),
          ...
          */
          ...
          insertDeleteLink = function(row) {
              ...
              var delButtonHTML = '<div class="col-12"><a class=" btn btn-danger ' + options.deleteCssClass + '" href="javascript:void(0)">' + options.deleteText +'</a></div>';
      ...
      if ($$.length) {
          ...
          var addButtonHTML = '<a id="'+options.addID+'" class="' + options.addCssClass + '" href="javascript:void(0)">' + options.addText + '</a>';
